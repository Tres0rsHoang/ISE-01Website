                ...
                <div id="lecturerCourseDetail" className="d-flex" style={{ padding: "2rem" }}>
                    <div className="courseSection" style={{ width: "70%" }}>
                        ...
                        <div className="currentLessonDetail">
                            <h4 className="currentLessonName my-4" style={{ fontWeight: "600" }}>Lesson 1 - Introduction</h4>
                    ...
                    <div className="lessonSection" style={{ width: "30%" }}>
                        ...
                        <div className="courseElementBtns pt-5 d-flex flex-column align-items-center">
                            <Button className="assignmentsBtn w-50 mb-4" style={{ height: "44px" }}><img className="me-2" src={fileIcon} alt="fileIcon"></img>Assignments</Button>
                            <Button className="materialsBtn w-50" style={{ height: "44px" }}><img className="me-2" src={fileIcon} alt="fileIcon"></img>Materials</Button>
                        </div>
                    </div>
                </div>
            </Content>
