        ...
        return (
            <div>
                ...
                <div className={"w3-animate-left"} id={"DashboardMenu"} style={{height: "calc(100vh - 100px)"}}>
                    <ul>
                        <a href={"/Student"}><li id="Nav-item"  className="d-flex align-items-center"><AiOutlineHome className="me-2"/>Dashboard</li></a>
                        <a href={"/Student"}><li id="Nav-item" className="d-flex align-items-center"><BsBookmark className="me-2"/>My Courses</li></a>
